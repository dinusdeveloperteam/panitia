    ...
    <div id="wrapper">
        ...
        -->
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h2 class="text-dark font-weight-bold">EDIT PELELANG</h2>
                                                    ...
                                                    <div class="box-body">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <img src="<?= base_url('vendors/images/') . $row['filektp']; ?>" alt="Gambar KTP <?= $row['nama'] ?>" width="375px" height="275px" class="img-fluid">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <fieldset disabled>
                                                            <div class="form-group">
                                                                <label class="col-sm-2 control-label disabledTextInput text-dark mt-3">ID Pelelang</label>
                                                                <div class="col-sm-10">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <img src="<?= base_url('vendors/images/') . $row['filenpwp']; ?>" alt="Gambar NPWP <?= $row['nama'] ?>" width="375px" height="275px" class="img-fluid">
                                                                </div>
                                                            </td>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label text-dark mt-3">NPWP</label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label text-dark">Bank</label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label text-dark">No Rekening</label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label text-dark">Atas Nama</label>
                                                            <div class="col-sm-10">
                                                        ...
                                                        <label for="basic-url" class="ml-3 text-dark">Status sebagai Pelelang</label><br>
                                                        <div class="col-sm-10">
                                                        ...
                                                        <label for="basic-url" class="ml-3">Jenis Usaha</label><br>
                                                        <div class="col-sm-10">
                                                            <div class="input-group mb-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-2 control-label text-dark">Deskripsi</label>
                                                            <div class="col-sm-10">
