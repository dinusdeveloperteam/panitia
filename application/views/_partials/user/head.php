    ...
    <div class="container">
      ...
      <nav class="navbar fixed-top shadow-sm navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
        ...
        <div class="collapse navbar-collapse px-lg-3" id="navbarCollapse">
            ...
            <div class="btn-group">
                <button type="button" class="dropdown-toggle button button-green text-white" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width:160px;">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- <a class="dropdown-item" href="<?//php echo anchor('peserta', 'Peserta', array('class' => 'nav-item nav-link h6'))?>">Keluar</a> -->
                    <?php echo anchor('logout', 'Keluar', array('class' => 'green dropdown-item'))?>
                    <!-- <script>
                        function alert(){
